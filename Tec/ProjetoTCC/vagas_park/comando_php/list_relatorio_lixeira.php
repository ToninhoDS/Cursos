...
if (!empty($pagina)) {
    $qnt_result_pg = $qt_tabela_relatorio_lixeira; 
            ...
            <table class='table' id='my-table'>
                <thead class='bg-light'>
                    <tr class='border-0' style='font-size: 17px;font-family: Impact, fantasy;'>
                        ...
                        <button  type='button' id='botao_confirma' value=''name='id_confirma'class='btn-danger btn-lg'onclick='confirma_registro()'' style='width: 180px; height: 35px;padding: 0px 25px;display:$muda_cargo;'>Limpar Lixeira</button>
