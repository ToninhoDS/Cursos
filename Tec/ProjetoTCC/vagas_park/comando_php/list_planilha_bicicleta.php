...
if (!empty($pagina)) {
    ...
    $query_usuarios = "SELECT  cd_status_vagas, cd_numero_vaga, nm_nome, img_icon, dt_entrada, sg_placa, cd_cpf, nm_status FROM tb_status_vagas WHERE img_icon = 'Bicicleta' ORDER BY cd_numero_vaga  DESC LIMIT $inicio, $qnt_result_pg";
...
while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
    ...
    <input type='text' id='valor_toleranciaP' style='display: none;' value='$vl_bike_tolerancia'>
    <input type='text' id='valor_entradaP' style='display: none;' value='$vl_bike_entrada'>
