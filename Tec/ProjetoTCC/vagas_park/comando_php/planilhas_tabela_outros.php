...
?>
                    <div class="influence-profile-content pills-regular">
                        ...
                        <a class="nav-link " id="pills-review-tab" href="detalhamento_servico_tabela.php"  role="tab" aria-controls="pills-review" aria-selected="true">Planilha de Moto<img src='../img/moto_vagas.png' style="margin:0 5px"width='25'></a>
                            ...
                            <li class="nav-item" style="margin:0 10px;">
                                <a class="nav-link" id="pills-msg-tab"  href="planilhas_tabela_bicicleta.php" role="tab" aria-controls="pills-msg" aria-selected="false">Planilha de Bicicleta<img src='../img/bike_vagas.jpg' style="margin:0 5px"width='25'></a>
                            </li>
                            <li class="nav-item" >
                                <a class="nav-link active" id="pills-packages-tab"  href="planilhas_tabela_outros.php" role="tab" aria-controls="pills-packages" aria-selected="false">Planilha de Outros<img src='../img/outros_vagas.png' style="margin:0 5px"width='25'></a>
                            </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade" id="pills-review" role="tabpanel" aria-labelledby="pills-review-tab">
                                        <h3 class="section-title">carro</h3>
                            </div>
                                    ...
                                    <div class="ecommerce-widget">
                                        <div class="row">					       
                                            <div class='col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12'>
                                                <div class="card">
                                                    <h3 class="card-header"  style='font-size: 40px;' >Planilha de<strong> Outros</strong></h3>
                                                    ...
                                                    <div style="padding: 5px 5px ;" class="col-md-3">                                       
                                                        ...
                                                        <span class="list_planilha_outros"></span>
                                                    </div>
                                                </div>                
                                            </div>
                                        </div>
...
<!-- fim Modal -->
    ...
    <!-- planilhas -->
    <script src="../chart_js/custom_planilha_outros.js"></script>
