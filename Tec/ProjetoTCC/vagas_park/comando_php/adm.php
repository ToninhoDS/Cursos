            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/vagas_park/comando_php/adm.php" aria-expanded="false" data-target="#submenu-2"  ><i class="fa fa-fw fa-users"></i>Administrador</a>
                         </li>
                         <li class="nav-item">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="user-avatar text-center d-block">
                                        <img src="<?php echo $diretorio,'/',recuperarImagemToken() ?>" alt="User Avatar" class="rounded-circle user-avatar-xxl">
                                    </div>
                                    <div class="text-center">
                                        <h2 class="font-24 mb-0"style='font-size:30px;color:black' ><?php echo recuperarNomeToken() ?></h2>
                                        <p>Cargo de  <strong style='font-size:17px;color:black'><?php echo '&nbsp;'.recuperarCargoToken(). '&nbsp;' ?></strong> dessa Empresa</p>
                                    </div>
                                </div>
                                <div class="card-body border-top">
                                    <h3 class="font-16">Informações de Contato</h3>
                                    <div class="">
                                        <ul class="list-unstyled mb-0">
                                        <li class="mb-2"><i class="fas fa-fw fa-envelope mr-2"></i><?php echo recuperarEmailToken() ?></li>
                                        <li class="mb-0"><i class="fas fa-fw fa-phone mr-2"></i><?php echo recuperarTelefoneToken() ?></li>
                                    </ul>
                                    </div>
                                </div>
                                <div class="card-body border-top">
                                ...
                                <div class="card-body border-top">
                                    <h3 class="font-16">Redes Sociais</h3>
                                    <div class="">
                            ...
                            <div class="influence-profile-content pills-regular">
                                <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" style="margin:0 20px;">
                                        <a class="nav-link" id="pills-packages-tab" data-toggle="pill" href="#pills-packages" role="tab" aria-controls="pills-packages" aria-selected="false">Vazio</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-pane fade" id="pills-review" role="tabpanel" aria-labelledby="pills-review-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $count_Livre?></h1>
                                                        <p>Livres</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $count_Ocupada?></h1>
                                                        <p>Ocupadas</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $count_Resultado?></h1>
                                                        <p>Reservas</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $vagas_total?></h1>
                                                        <p>Total de Vagas</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $count_carro?></h1>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $count_motos?></h1>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $count_bicic?></h1>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $count_outros?></h1>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                            <div class="mr-4">
                                                                <img src="../img/empresa02.png" alt="User Avatar" class="user-avatar-lg">
                                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="media influencer-profile-data d-flex align-items-center p-2">
                                                            <div class="mr-4">
                                                                <img src="../img/empresa03.png" alt="User Avatar" class="rounded-circle user-avatar-lg">
                                                            </div>
                                                            <div class="media-body">
...
<!-- Modal -->
             <div class="modal fade" id="msgCardSucesso" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
                 <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <!-- SE NAO FOR GERENTE NAO TEM ACESSO -->
<?php
    $cargo = recuperarCargoToken();
    if($cargo =='Funcionario'){
       echo "<div class='tab-pane fade' id='pills-msg' role='tabpanel' aria-labelledby='pills-msg-tab'>
                <div class='card'>
                    <h2 class='card-header'>Não tem acesso ao Cadastro de Funcionario</h2>
                    <div class='card-body'>
                    </div>
                </div>
            </div>";
