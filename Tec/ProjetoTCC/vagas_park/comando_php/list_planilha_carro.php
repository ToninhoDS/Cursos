...
while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
    ...
    <input type='text' id='valor_toleranciaP' style='display: none;' value='$vl_carro_tolerancia'>
    <input type='text' id='valor_entradaP' style='display: none;' value='$vl_carro_entrada'>
    <input type='text' id='valor_horaP' style='display: none;' value='$vl_carro_hora'>
