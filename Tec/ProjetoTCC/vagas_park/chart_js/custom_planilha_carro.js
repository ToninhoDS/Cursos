...
const listarUsuarios = async (pagina) => {
    ...
    const dados = await fetch("./list_planilha_carro.php?pagina=" + pagina);
    ...
    if (!resposta['status']) {
        ...
        const conteudo = document.querySelector(".list_planilha_carro");
...
async  function visualizar(id){
    ...
    if(!resposta['status']){
        ...
        //FIM DA TOLERANCIA
        console.log("Segundo: " + valor_entradaP);
