...
const listarUsuarios = async (pagina) => {
    ...
    const dados = await fetch("./list_planilha_bicicleta.php?pagina=" + pagina);
    ...
    if (!resposta['status']) {
        ...
        const conteudo = document.querySelector(".list_planilha_bicicleta");
...
async function salvar_registro(id){
    ...
    var img_Option_valor = 'Bicicleta';
...
async  function visualizar(id){
    ...
    if(!resposta['status']){
        ...
        var calular_valorPagarP = valor_entradaP ;
        // fim do calculo
