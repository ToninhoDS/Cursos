...
// Recuperar o id do gerente salvo no token
function recuperarIdGerenteToken(){
    // Recuperar o token do cookie
    $token = $_COOKIE['token'];
    ...
    // Retorna o id do gerente salvo no token
    return $dados_token->cd_gerente;
}
...
function recuperarEmailToken(){
    ...
    // Retorna o nome do usuário salvo no token
    return $dados_token->nm_email;
}
// Recuperar o img salvo no token
function recuperarImagemToken(){
    // Recuperar o token do cookie
    $token = $_COOKIE['token'];
    ...
    // Retorna o img do gerente salvo no token
    return $dados_token->cd_img;
}
// Recuperar o CARGO  salvo no token
function recuperarCargoToken(){
    // Recuperar o token do cookie
    $token = $_COOKIE['token'];
    ...
    // Retorna o img do gerente salvo no token
    return $dados_token->cargo_privilegio;
    
}
// Recuperar o telefone  salvo no token
function recuperarTelefoneToken(){
    ...
    // Retorna o img do gerente salvo no token
    return $dados_token->cd_telefone;
  
}
// Recuperar o telefone  salvo no token
function recuperarPrivilegioToken(){
    // Recuperar o token do cookie
    $token = $_COOKIE['token'];
