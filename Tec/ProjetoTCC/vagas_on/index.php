...
<head>
    ...
    <link rel="stylesheet" href="home_vagas/css/footer_gif.css">
    <link rel="stylesheet" href="home_vagas/css/selection.css" />
    <link rel="stylesheet" href="home_vagas/css/cards.css" />
    <link rel="stylesheet" href="home_vagas/css/style.css"/>
    <link rel="stylesheet" href="home_vagas/css/animacao.css"/>
    <link rel="stylesheet" type="text/css" href="home_vagas/css/header.css"/>
    <link rel="stylesheet" href="home_vagas/css/perfil-usuario.css">
    <link rel="stylesheet" href="home_vagas/css/faq.css">

    <script src="home_vagas/js/perfil-usuario.js" defer></script>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link tablinks" onclick="openPage(event, 'home')" id="defaultOpen" href="javascript:void(0);"><i class="fa fa-window-maximize" aria-hidden="true"></i>Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link tablinks" href="/vagas_park/comando_php/cadastrar_parceiro.php" href="javascript:void(0);"><i class="far fa-clone"></i>Serviços</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link tablinks" href="/vagas_park/comando_php/login_mobile.php"  href="javascript:void(0);"><i class="far fa-address-book"></i>Para Celular</a>
                </li>
                <li class="nav-item">
                ...
                <div class="div-block-48">
                  <h1 class="heading-47-copy-copy">
                    ...
                    <div class="w-col w-col-6">
                      ...
                      <img src="home_vagas/img/picwish.png" width="700" loading="lazy" alt="" class="image-34 animar" alt="Imagem Animada">
                      <a href="/vagas_park/comando_php/cadastrar_parceiro.php" id="btn-subscribe-1" target="_blank" class="button-primary-2 b2 w-button animar">Inscreva-se</a>
                      </div>
                    </div>
            </div>
            </div>
...
<div class="hero-wrapper-2">
  ...
  <img src="home_vagas/img/empresa.png" loading="lazy" width="303" alt="Imagem Animada" class="shadow-two-2"/>
  </div>
  <div class="hero-split">
    <h1 class="heading-39-copy">
      ...
      <a href="/vagas_park/comando_php/cadastrar_parceiro.php" id="btn-subscribe-5" target="_blank" class="button-primary-2 b2 w-button">Inscreva-se</a>
      </div>
    </div>
  </div>
</section>
      ...
      <div>
        <div class="columns-12 w-row">
          <div class="column-16 w-col w-col-4">
            <img src="home_vagas/img/lampada_azul (2).png" width="250px" loading="lazy" alt="Imagem Animada" class="image-52"/>
          </div>
...
<div class="pricing-grid anima_solucao02">
  <div id="w-node-_974380d3-70c9-716e-b239-4e871a69f7fb-13aa7487" class="pricing-card-three">
    <div>
      <div class="columns-12 w-row">
        <div class="column-16 w-col w-col-4">
          <img src="home_vagas/img/segurando03.png" width="300px" loading="lazy" alt="Imagem Animada" class="image-53"/>
        </div>
      <div class="column-15 w-col w-col-8">
        <h1 class="heading-41-copy">
...
<div class="pricing-grid anima_solucao03">
  <div id="w-node-_974380d3-70c9-716e-b239-4e871a69f7fb-13aa7487" class="pricing-card-three">
    <div>
      <div class="columns-12 w-row">
        <div class="column-16 w-col w-col-4">
          <img src="home_vagas/img/rapido.png" width="300px" loading="lazy" alt="Imagem Animada" class="image-53"/>
        </div>
      <div class="column-15 w-col w-col-8">
        <h1 class="heading-41-copy">
      ...
      <div class="w-container">
        <div class="columns-12 w-row">
          <div class="column-23 w-col w-col-4 anima_solucao04">
            <img src="home_vagas/img/logo_fondo3-icon.png" width="400px" style="margin: -10rem;" loading="lazy" alt="Imagem Animada" class="image-35"/>
          </div>
                ...
                <div class="div-block-44"><h1 class="heading-44">
                      ...
                      <div class="column-17 w-col w-col-6">
                        <div class="div-block-43">
                          ...
                          <a href="/vagas_park/comando_php/cadastrar_parceiro.php" id="btn-subscribe-5" target="_blank" class="button-primary-2 w-button">Inscreva-se</a>
            </div>
          </div>
        </div>
</section>
...
<div class="faq-container">
  ...
  <script src="home_vagas/js/script.js"></script>
  <script src="home_vagas/js/scriptt.js"></script>                                                                                                       
  <script src="home_vagas/js/selection.js"></script>
  <script src="home_vagas/js/faq.js"></script>
