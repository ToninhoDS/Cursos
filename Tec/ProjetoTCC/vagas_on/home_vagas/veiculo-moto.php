...
<head>
    ...
    <title>Configurações - Moto</title>
</head>
...
<div id="section-veiculos"> 
        <div class="form-info">
            <div class="section-carro">
                <h2>Meus veículos - Moto </h2>
                <div class="img"><img src="img/moto-icon.svg" alt="" srcset=""></div> 
            </div>
                <form method="POST">
                    <div class="wrapper">
                        <label class="label-info" for="first_name">Placa da moto</label>
                        <input type="text" class="info-conta" id="marca_carro" name="placa_moto">

                        <label class="label-info" for="first_name">Marca da moto</label>
                        <input type="text"  class="info-conta" id="cor_carro" name="modelo_moto">

                        <label class="label-info" for="first_name">Cor</label>
                        <input type="text"  class="info-conta" id="cor_carro" name="cor_moto">
                    </div>
