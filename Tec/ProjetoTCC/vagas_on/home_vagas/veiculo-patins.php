...
<head>
    ...
    <title>Configurações - Patins</title>
</head>
...
<div id="section-veiculos"> 
        <div class="form-info">
            <div class="section-carro">
                <h2>Meus veículos - Patins </h2>
                <div class="img"><img src="img/patins-icon.svg" alt="" srcset=""></div>
            </div>
                <form>
                    <div class="wrapper">
                        <label class="label-info" for="first_name">Marca do patins </label>
