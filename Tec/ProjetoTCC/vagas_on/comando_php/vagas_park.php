...
?>
    ...
    <h5 id='somaHora_valor' style='display:none' value='<?php echo $diff_minutes ?>'><?php echo $diff_minutes ?></h5>
    <h5 id='vl_carro_tolerancia' style='display:none' value='<?php echo $vl_carro_tolerancia ?>'><?php echo $vl_carro_tolerancia ?></h5>
    <h5 id='vl_carro_entrada' style='display:none' value='<?php echo $vl_carro_entrada ?>'><?php echo $vl_carro_entrada ?></h5>
    <h5 id='vl_carro_hora' style='display:none' value='<?php echo $vl_carro_hora ?>'><?php echo $vl_carro_hora ?></h5>
    <h5 id='vl_moto_tolerancia' style='display:none' value='<?php echo $vl_moto_tolerancia ?>'><?php echo $vl_moto_tolerancia ?></h5>
    <h5 id='vl_moto_entrada' style='display:none' value='<?php echo $vl_moto_entrada ?>'><?php echo $vl_moto_entrada ?></h5>
    <h5 id='vl_moto_hora' style='display:none' value='<?php echo $vl_moto_hora ?>'><?php echo $vl_moto_hora ?></h5>
    <h5 id='vl_bike_tolerancia' style='display:none' value='<?php echo $vl_bike_tolerancia ?>'><?php echo $vl_bike_tolerancia ?></h5>
    <h5 id='vl_bike_entrada' style='display:none' value='<?php echo $vl_bike_entrada ?>'><?php echo $vl_bike_entrada ?></h5>
    <h5 id='vl_outros_tolerancia' style='display:none' value='<?php echo $vl_outros_tolerancia ?>'><?php echo $vl_outros_tolerancia ?></h5>
    <h5 id='vl_outros_entrada' style='display:none' value='<?php echo $vl_outros_entrada ?>'><?php echo $vl_outros_entrada ?></h5>
