...
if (!empty($pagina)) {
    ...
    $query_usuarios = "SELECT  cd_status_vagas, cd_numero_vaga, nm_nome, img_icon, dt_entrada, sg_placa, cd_cpf, nm_status FROM tb_status_vagas WHERE img_icon = 'Outros' ORDER BY cd_numero_vaga  DESC LIMIT $inicio, $qnt_result_pg";
                    ...
                    <table class='table' id='my-table'>
                        <thead class='bg-light'>
                            <tr class='border-0' style='font-size: 16px;font-family: Impact, fantasy;'>
                                ...
                                <th style='display:none;' class='border-0'>Placa</th>
...
while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
    ...
    <input type='text' id='valor_toleranciaP' style='display: none;' value='$vl_outros_tolerancia'>
    <input type='text' id='valor_entradaP' style='display: none;' value='$vl_outros_entrada'>
    ...
    <td style='display:none;' id='valor_placa$cd_status_vagas'>$sg_placa</td>
