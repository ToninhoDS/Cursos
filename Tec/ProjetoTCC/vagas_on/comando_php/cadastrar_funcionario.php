...
$dados = filter_input_array(INPUT_POST, FILTER_DEFAULT);
 ...
 //privilegios da conta que geerente esta criando
 $cargo_privilegio = 'Funcionario';
 //DADOS DO GERENTE
// recuperando o id do Gerente
 $id_gerente = recuperarIdGerenteToken();
 $nome_gerente = recuperarNomeToken();
...
$nm_descricao_acao ='Ação foi para CADASTRO DE FUNCIONARIO';
...
// fim
    ...
    (nm_nome, nm_cargo, nm_formacao, dt_emissao_contratual, nm_sexo, nm_maternidade, nm_estado_civil, cd_data_nascimento,  cd_idade, cd_cpf, cd_rg, cd_credencial, cd_email_funcionario, cd_telefone, img_imagem, cd_bairro, cd_gerente, cargo_privilegio, cd_senha_funcionario)
    
    VALUES (:nm_nome, :nm_cargo, :nm_formacao, :dt_emissao_contratual, :nm_sexo, :nm_maternidade, :nm_estado_civil, :cd_data_nascimento, :cd_idade, :cd_cpf, :cd_rg, :cd_credencial, :cd_email_funcionario, :cd_telefone, :img_imagem, :cd_bairro, :cd_gerente, :cargo_privilegio, :cd_senha_funcionario)";
    ...
    $cadastrar_funcionario->bindParam(':cargo_privilegio', $cargo_privilegio);
    
    // $cadastrar_funcionario->bindParam(':cd_senha_funcionario', $dados['cd_senha_funcionario']);
 // Criptografar a senha
    $senha_criptografada = password_hash($dados['cd_senha_funcionario'], PASSWORD_DEFAULT);
    $cadastrar_funcionario->bindParam(':cd_senha_funcionario', $senha_criptografada);
    
    $id_funcionario = $conn->lastInsertId();
    $cadastrar_funcionario->execute();  
