...
?>
                    <div class="influence-profile-content pills-regular">
                        ...
                        <a class="nav-link " id="pills-review-tab" href="detalhamento_servico_tabela.php"  role="tab" aria-controls="pills-review" aria-selected="true">Planilha de Moto<img src='../img/moto_vagas.png' style="margin:0 5px"width='25'></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-campaign-tab"  href="planilhas_tabela_carro.php" role="tab" aria-controls="pills-campaign" aria-selected="true">Planilha de Carro<img src='../img/carro_vagas.png' style="margin:0 5px"width='25'></a>
                            </li>
                            <li class="nav-item" style="margin:0 10px;">
                                    ...
                                    <div class="ecommerce-widget">
                                        <div class="row">					       
                                            <div class='col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12'>
                                                <div class="card">
                                                    <h3 class="card-header"  style='font-size: 40px;' >Planilha de<strong> Carro</strong></h3>
                                                    ...
                                                    <div style="padding: 5px 5px ;" class="col-md-3">                                       
                                                        ...
                                                        <span class="list_planilha_carro"></span>
                                                    </div>
                                                </div>                
                                            </div>
                                        </div>
...
<!-- fim Modal -->
    ...
    <!-- planilhas -->
    <script src="../chart_js/custom_planilha_carro.js"></script>
