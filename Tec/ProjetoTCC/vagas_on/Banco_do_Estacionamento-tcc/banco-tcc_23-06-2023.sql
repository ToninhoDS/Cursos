...
nm_usuario_login varchar(100), -- add aqui sua alteração
constraint pk_login
...
cd_email_usuario varchar(80),
cd_senha_usuario varchar(80),
cd_cpf varchar (20),
...
nm_senha varchar (250),
cd_telefone varchar (20),
cd_img varchar (150),
cargo_privilegio varchar (50),
cd_bairro int,
...
cd_email_funcionario varchar(250),
cd_senha_funcionario varchar (250),
cd_telefone varchar (20),
img_imagem varchar (250),
cargo_privilegio varchar (50), -- identifica o privilegio desse login 
cd_bairro int,
cd_gerente int,
...
create table if not exists tb_registro_de_sistema(
cd_registro_de_sistema int not null auto_increment,
nm_nome_acao varchar(20),
nm_descricao_acao varchar (250),
nm_origem varchar (50),
nm_funcionario varchar (100),
...
dt_data date,
img_icon varchar (150),
nm_gerente varchar (150),
nm_cargo varchar (150),
constraint pk_registro_de_sistema
primary key (cd_registro_de_sistema)
) engine=InnoDB auto_increment=0;
...
primary key (cd_status_vagas)
 ...
 -- criação da tabela de configuração do sistema
create table if not exists tb_configuracao_dashboard(
cd_configuracao_dashboard int not null auto_increment,
vl_carro_tolerancia varchar(20),
vl_carro_entrada varchar (20),
vl_carro_hora varchar (20),
vl_moto_tolerancia varchar (20),
vl_moto_entrada varchar (20),
vl_moto_hora varchar (20),
vl_bike_tolerancia varchar (20),
vl_bike_entrada varchar (20),
vl_outros_tolerancia varchar (20),
vl_outros_entrada varchar (20),
qt_carro_vagas varchar (20),
qt_moto_vagas varchar (20),
qt_bike_vagas varchar (20),
qt_outros_vagas varchar (20),
qt_tabela_cliente varchar (20),
qt_tabela_notificacao varchar (20),
qt_tabela_vagas varchar (20),
nm_layout_navbar varchar (20),
nm_layout_font varchar (150),
nm_layout_zoom varchar (20),
nm_layout_discanso varchar (100),
qt_tabela_vagas_detalhes varchar (100),
qt_tabela_relatorio_lixeira varchar (100),
qt_tabela_relatorio_limpar varchar (100),
qt_tabela_relatorio_atividade varchar (100),
nm_config_nomeEmpresa  varchar (150),
dt_hora time,
dt_data date,
constraint pk_configuracao_dashboard
primary key (cd_configuracao_dashboard)
) engine=InnoDB auto_increment=0;
-- Fim
